...
#ifndef RV_PRIVATELINKAGE_INCL
#define RV_PRIVATELINKAGE_INCL
...
struct PrivateLinkageProperties : public TR::RVLinkageProperties {
   PrivateLinkageProperties();
};
...
class PrivateLinkage : public J9::PrivateLinkage
   ...
   static const PrivateLinkageProperties _properties;
