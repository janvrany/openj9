...
#ifndef J9_RV_CPU_INCL
#define J9_RV_CPU_INCL
...
namespace J9 { namespace RV { class CPU; } }
namespace J9 { typedef J9::RV::CPU CPUConnector; }
#else
#error J9::RV::CPU expected to be a primary connector, but a J9 connector is already defined
#endif
